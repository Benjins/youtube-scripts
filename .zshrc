...
COMPLAINT_REGEXP='(finished with exit status [1-9]| bailing out\.\.\.|Connection reset by peer|node_modules/cassandra-driver|CalledProcessError|Connection refused|Remote end closed connection without response|Not enough local disk)'
